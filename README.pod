...
HTML:
  ...
  <div ng-app="myApp" ng-controller="myCtrl as crtl">
    <div ng-if=" ctrl.tpls1[0] != 'ready' ">Loading templates ...</div>
    
    <div ng-show=" ctrl.tpls2.ready ">My templates ready!</div>
  </div>
...
Optional string B<done_name> for checking when all temlates loaded success. Default to "done".
